    ...
    if "uplink_message" in some_json:
        ...
        if f_port != "-":
            ...
            for measurement, value in decoded_payload.items():
                write_to_influx.write_influx_sensor_data(
                    device_id, measurement, value, received_at
                )
